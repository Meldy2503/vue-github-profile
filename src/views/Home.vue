...
<template>
  <main
    class="bg-right bg-cover bg-[url('../assets/bg-stars-1.webp')] relative"
  >
    <div
      class="absolute top-72 right-0 min-[400px]:right-[50px] min-[550px]:right-[150px] m-auto md:top-0 md:right-0"
    >
      <img
        class="max-w-full w-[350px] md:w-[400px] lg:w-[500px] animate-spin"
        src="../assets/astrocat.png"
        alt="astronaut"
      />
    </div>
    ...
    <div
      class="text-light-1 mx-auto max-w-[1200px] w-[95%] min-[400px]:w-[90%] mt-10 md:mt-28 flex flex-col md:items-start items-center"
    >
      <h1
      ...
      <p
        class="text-xl text-light-3 w-full md:w-[50%] font-normal mt-4 text-center md:text-left z-50"
      >
